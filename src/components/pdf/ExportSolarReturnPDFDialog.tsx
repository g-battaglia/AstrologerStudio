  ...
  const handleExport = useCallback(async () => {
    ...
    try {
      ...
      if (exportOptions.includeChartWheel) {
        ...
        // Get return year from second_subject or subject
        ...
        try {
          ...
          console.warn('Failed to regenerate solar return chart with light theme:', err)
          if (chartWheelHtml) {
      ...
      const returnYear = returnSubject.year || new Date().getFullYear()
      link.download = `${subjectName}_solar_return_${returnYear}.pdf`
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Export Solar Return as PDF</DialogTitle>
          <DialogDescription>Configure what to include in your Solar Return report.</DialogDescription>
        </DialogHeader>
